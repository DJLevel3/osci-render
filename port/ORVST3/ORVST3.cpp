...
ORVST3::ORVST3(const InstanceInfo& info)
...
#if IPLUG_DSP
void ORVST3::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void ORVST3::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void ORVST3::OnParamChange(int paramIdx)
{
  mDSP.SetParam(paramIdx, GetParam(paramIdx)->Value());
}

bool ORVST3::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
