...
def  main():
  ...
  installer = "\installer\ORVST3 Installer.exe"
   
  if demo:
    installer = "\installer\ORVST3 Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\ORVST3 manual.pdf" 
  ]
  ...
  ZIPNAME = "ORVST3-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "ORVST3-v" + FULLVERSIONSTR + "-win-demo.zip"
