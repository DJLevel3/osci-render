...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ORVST3 Demo Installer\n"
      else:
        line="OutputBaseFilename=ORVST3 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ORVST3 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ORVST3 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ORVST3 Demo installer\n"
     else:
       line="SetupWindowTitle=ORVST3 installer\n"
